...
@RestController
@RequestMapping("/api/jh-sample-application-kafka")
public class JhSampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhSampleApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhSampleApplicationKafkaResource(KafkaProperties kafkaProperties) {
